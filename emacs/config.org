...
- [[#important-programs-to-load-first][IMPORTANT PROGRAMS TO LOAD FIRST]]
  ...
  - [[#removes-the--symbol-in-m-x][REMOVES THE ^ symbol in M-x]]
- [[#all-the-icons][ALL THE ICONS]]
- [[#app-launcher][APP LAUNCHER]]
  - [[#emacs-run-launcher][Emacs Run Launcher]]
...
- [[#org-mode][ORG MODE]]
  ...
  - [[#toggling-org-pretty-mode][Toggling Org Pretty Mode]]
...
(adi/leader-keys
  "p" '(emacs-run-launcher :wk "Application Launcher")
)
(adi/leader-keys
  "m" '(:ignore t :wk "Org")
...
(adi/leader-keys
  ...
  "m b n" '(org-table-create :wk "Create table of m x n dimensions"))
...
(adi/leader-keys
  "r" '(projectile-command-map :wk "Projectile"))
)
...
|------------------------+-----------------------------------------|
|           <a           | ’#+BEGIN EXPORT ascii’ … ‘#+END EXPORT  |
|           <c           |    ’#+BEGIN CENTER’ … ‘#+END CENTER’    |
|           <C           |   ’#+BEGIN COMMENT’ … ‘#+END COMMENT’   |
|           <e           |   ’#+BEGIN EXAMPLE’ … ‘#+END EXAMPLE’   |
|           <E           |    ’#+BEGIN EXPORT’ … ‘#+END EXPORT’    |
|           <h           | ’#+BEGIN EXPORT html’ … ‘#+END EXPORT’  |
|           <l           | ’#+BEGIN EXPORT latex’ … ‘#+END EXPORT’ |
|           <q           |     ’#+BEGIN QUOTE’ … ‘#+END QUOTE’     |
|           <s           |       ’#+BEGIN SRC’ … ‘#+END SRC’       |
|           <v           |     ’#+BEGIN VERSE’ … ‘#+END VERSE’     |
|------------------------+-----------------------------------------|
