...
-- whikey plugin shows keybind suggestions
{
...
vim.keymap.set('n', '<Tab>k', ':BufferPrevious<CR>')
vim.keymap.set('n', '<S-Tab><Right>', ':BufferMoveNext<CR>')
vim.keymap.set('n', '<S-Tab>j', ':BufferMoveNext<CR>')
vim.keymap.set('n', '<S-Tab><Left>', ':BufferMovePrevious<CR>')
vim.keymap.set('n', '<S-Tab>k', ':BufferMovePrevious<CR>')
